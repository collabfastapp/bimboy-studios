  ...
  return (
    <section className="surface-card rounded-[32px] px-6 py-8 sm:px-8">
      ...
      <h1 className="mt-4 text-4xl font-black tracking-tight text-white">
        Creator dashboard baseline
      </h1>
      <p className="mt-4 max-w-3xl text-base leading-8 text-white/64">
        This is the creator-facing home for profile, content, earnings, and
        royalty tools. It is intentionally simple and ready for phased buildout.
      </p>
    </section>
  );
}
